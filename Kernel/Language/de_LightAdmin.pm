...
sub Data {
    ...
    $Self->{Translation}->{'To get the first 20 characters of the subject of the current/latest agent article (current for Answer and Forward, latest for Note template type). This tag is not supported for other template types.'} =
        '';
    $Self->{Translation}->{'To get the first 5 lines of the body of the current/latest agent article (current for Answer and Forward, latest for Note template type). This tag is not supported for other template types.'} =
        '';
    $Self->{Translation}->{'To get the first 20 characters of the subject of the current/latest article (current for Answer and Forward, latest for Note template type). This tag is not supported for other template types.'} =
        '';
    $Self->{Translation}->{'To get the first 5 lines of the body of the current/latest article (current for Answer and Forward, latest for Note template type). This tag is not supported for other template types.'} =
        '';
    ...
    $Self->{Translation}->{'%s (copy)'} = '';
    $Self->{Translation}->{'Notifications could not be Imported due to a unknown error, please check OTOBO logs for more information'} =
        '';
    $Self->{Translation}->{'Invisible to customer'} = '';
    $Self->{Translation}->{'Visible to customer'} = '';
